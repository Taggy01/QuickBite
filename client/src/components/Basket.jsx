...
function BasketItems({ user, basket }) {
    ...
    return (
        <div className="drawer-side fixed inset-0 z-50 font-geist">
            ...
            <div className="bg-blue-50 w-100 max-w-full h-screen flex flex-col ml-auto">
                        ...
                        {basket.map(({ _id, productId, quantity }) => (
                            <div className="flex gap-4 justify-between p-2" key={_id}>
                                ...
                                <div className="flex items-center gap-2">
                                    <button className="btn btn-square btn-primary text-lg btn-xs" >
                                        -
                                    </button>
                                    <span>{quantity}</span>
                                    <button className="btn btn-square btn-primary text-lg btn-xs" >
                ...
                {/* Footer */}
                <div
                    className={`btn w-full h-20 mt-4 flex items-center rounded-t-2xl rounded-b-none justify-between ${isLoggedIn
